...
function Applyjob({name, setname, email, setemail, jobid, setjobid, applyjob, answer, setanswer}){
  return(
    <div style={{display: "flex",flexDirection: "column",alignItems: "center",gap: "10px", border: "2px solid blue", borderRadius: "6px", backgroundColor: "white", padding:"20px"}}>
      ...
      <input placeholder="Job code" value={jobid} onChange={e=>setjobid(e.target.value)} style={{width: "100%",padding: "8px",border: "1px solid black",borderRadius: "4px"}}/>
      <input placeholder="Answer" value={answer} onChange={e=>setanswer(e.target.value)} style={{width:"100%",padding:"8px",border:"1px solid black",borderRadius:"4px"}}/>
