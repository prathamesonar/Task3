...
function Createjob({title, settitle, description, setdescription, createjob, question, correctanswer, setcorrectanswer, setquestion}){
  return(
    <div style={{display: "flex",flexDirection: "column",alignItems: "center",gap: "15px", border: "2px solid blue", borderRadius: "6px", backgroundColor: "white", padding:"20px"}}>
      <h2>Create a Job</h2>
      ...
      <input placeholder="correctanswer" value={correctanswer} onChange={e=>setcorrectanswer(e.target.value)} style={{width:"100%",padding:"8px"}}
/>
